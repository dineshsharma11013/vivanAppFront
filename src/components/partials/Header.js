      ...
      <div className="row">
        ...
        <div className="col-3 col-lg-1 col-xl-2 m-auto">
          <a href="index.html" className="logo-area">
            <img src="/assets/img/logo-black.png" alt="Logo" className="img-fluid" />
          </a>
        </div>
        {/* Logo Area End */}
        ...
        <div className="col-3 col-lg-9 col-xl-8 m-auto">
          <div className="main-menu-wrap">
            <nav id="mainmenu">
              <ul>
                <li className="dropdown-show"><a href="index.html">Home</a>
                ...
                <li className="dropdown-show"><a href="#">Shop</a>
                  <ul className="mega-menu-wrap dropdown-nav">
                    <li className="mega-menu-item"><a href="shop.html" className="mega-item-title">Shop
                        Layout</a>
                      <ul>
                    ...
                    <li className="mega-menu-item"><a href="single-product.html" className="mega-item-title">Single
                        Products</a>
                      <ul>
                ...
                <li className="dropdown-show"><a href="#">Pages</a>
                ...
                <li className="dropdown-show"><a href="#">Men</a>
                  <ul className="mega-menu-wrap dropdown-nav">
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Shirt</a>
                      <ul>
                    ...
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Jeans</a>
                      <ul>
                    ...
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Shoes</a>
                      <ul>
                        <li><a href="shop.html">Tops &amp; Tees</a></li>
                        <li><a href="shop.html">Polo Short Sleeve</a></li>
                        <li><a href="shop.html">Graphic T-Shirts</a></li>
                    ...
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Watches</a>
                      <ul>
                        <li><a href="shop.html">Crochet</a></li>
                        <li><a href="shop.html">Sleeveless</a></li>
                        <li><a href="shop.html">Stripes</a></li>
                ...
                <li className="dropdown-show"><a href="shop-left-full-wide.html">Women</a>
                  <ul className="mega-menu-wrap dropdown-nav">
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Kamiz</a>
                      <ul>
                        <li><a href="shop.html">Tops &amp; Tees</a></li>
                        <li><a href="shop.html">Polo Short Sleeve</a></li>
                        <li><a href="shop.html">Graphic T-Shirts</a></li>
                    ...
                    <li className="mega-menu-item"><a href="shop-left-full-wide.html" className="mega-item-title">Life Style</a>
                      <ul>
                        <li><a href="shop.html">Crochet</a></li>
                        <li><a href="shop.html">Sleeveless</a></li>
                        <li><a href="shop.html">Stripes</a></li>
                ...
                <li className="dropdown-show"><a href="#">Blog</a>
                  <ul className="dropdown-nav">
        ...
        <div className="col-6 col-lg-2 m-auto">
          <div className="header-right-meta text-right">
            <ul>
              ...
              <li className="settings"><a href="#"><i className="fa fa-cog" /></a>
                <div className="site-settings d-block d-sm-flex">
                  <dl className="currency">
                    <dt>Currency</dt>
                    <dd className="current"><a href="#">USD</a></dd>
                    <dd><a href="#">AUD</a></dd>
                    <dd><a href="#">CAD</a></dd>
                    <dd><a href="#">BDT</a></dd>
                  </dl>
                  ...
                  <dl className="language">
                    <dt>Language</dt>
                    <dd className="current"><a href="#">English (US)</a></dd>
              ...
              <li className="shop-cart"><a href="#"><i className="fa fa-shopping-bag" /> <span className="count">3</span></a>
                <div className="mini-cart">
                  ...
                  <div className="mini-cart-footer">
                    <a href="checkout.html" className="btn-add-to-cart">Checkout</a>
                  </div>
                </div>
              </li>
            </ul>
